...
##nl.ReUploadFile(projectname="FOX USI 59 Bekleidungs-Shop mit Formeln und Datumsgruppe",filename="fox_files/Bekleidungs-Shop mit Formeln und Datumsgrupppe.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 97 Angebotsbestand",filename="fox_files/Demodaten/BUAA/Angebotsbestand_Demodaten/Angebotsbestand_final.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 97 CeBit 2014 InfoZoomVending",filename="fox_files/Demodaten/CeBit 2014/Vending/InfoZoomVending.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 85 Elektronikfachhandel Umsatz",filename="fox_files/Demodaten/BeispieltabellenInfoZoom2019/Beispieltabellen 2019/Umsatzanalyse/Elektronikfachhandel/Umsatz.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 55 ABC-Kunden",filename="fox_files/Demodaten/ABC-Kunden/ABC-Kunden.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 38 Nordwind (CeBit 2014)",filename="fox_files/Nordwind.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 89 PDH_PROD_PMCC_DQChecks_Reduced 7b",filename="fox_files/PDH_PROD_PMCC_DQChecks_Reduced 7b.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 96 PDH_PROD_PMCC_Reduced (DQ Status)",filename="fox_files/PDH_PROD_PMCC_Reduced (DQ Status).fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 99 PDH_PROD_PMCC_Reduced (Availability Check)",filename="fox_files/PDH_PROD_PMCC_Reduced (Availability Check).fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 98 LongFormulas LangeFormeln",filename="fox_files/LongFormulas/LangeFormeln.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 96 PDH_PROD_PMCC_Reduced (Volume Check)",filename="fox_files/PDH_PROD_PMCC_Reduced (Volume Check)).fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 45 PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01",filename="fox_files/PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 99 List&Label Academy Serienbrief",filename="fox_files/Demodaten/List&Label/03_Academy_Serienbrief_Karte/IZCP_Anonym.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 99 Covid",filename="fox_files/Demodaten/Covid/Covid_30.11.2021.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 99 Analyzer Master VisKkontakte",filename="fox_files/Demodaten/proALPHA Analyzer Master/masterd__viskontakte.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 99 Geodaten Distanzkalkulation",filename="fox_files/Demodaten/Geodaten/Distanzkalkulation.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
