...
##nl.ReUploadFile(projectname="FOX USI 98 ABC-Kunden",filename="fox_files/Demodaten/ABC-Kunden/ABC-Kunden.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
##nl.ReUploadFile(projectname="FOX USI 90 Elektronikfachhandel Umsatz",filename="fox_files/Demodaten/BeispieltabellenInfoZoom2019/Beispieltabellen 2019/Umsatzanalyse/Elektronikfachhandel/Umsatz.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 95 Nordwind (CeBit 2014)",filename="fox_files/Nordwind.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
nl.ReUploadFile(projectname="FOX USI 97 Movies",filename="fox_files/Demodaten/Movies/Movies.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
