...
##nl.ReUploadFile(projectname="FOX USI 92 Nordwind (CeBit 2014)",filename="fox_files/Nordwind.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 85 Prüfung offene RG",filename="fox_files/Demodaten/Prüfsoftware/Prüfung_offene_RG.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 96 Buchausleihe",filename="fox_files/Demodaten/Bibliothek_CRM/Buchausleihe.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 92 PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01",filename="fox_files/PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
