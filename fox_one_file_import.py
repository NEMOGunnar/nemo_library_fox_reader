...
##nl.ReUploadFile(projectname="FOX USI 57 Nordwind (CeBit 2014)",filename="fox_files/Nordwind.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 83 Prüfung offene RG",filename="fox_files/Demodaten/Prüfsoftware/Prüfung_offene_RG.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 60 Nordwind (CeBit 2014)",filename="fox_files/Nordwind (Reduced 1).fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
