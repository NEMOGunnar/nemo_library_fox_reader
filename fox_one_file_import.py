...
##nl.ReUploadFile(projectname="FOX USI 62 Bekleidungs-Shop",filename="fox_files/Bekleidungs-Shop 2018 mit Analyse.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
nl.ReUploadFile(projectname="FOX USI 99 Elektronikfachhandel Umsatz",filename="fox_files/Demodaten/BeispieltabellenInfoZoom2019/Beispieltabellen 2019/Umsatzanalyse/Elektronikfachhandel/Umsatz.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
