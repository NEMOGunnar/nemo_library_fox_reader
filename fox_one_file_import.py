...
##nl.ReUploadFile(projectname="FOX USI 82 Prüfung offene RG",filename="fox_files/Demodaten/Prüfsoftware/Prüfung_offene_RG.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 89 PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01",filename="fox_files/PDH_PROD_PMCC_Global_Attributes_incl_SAP_2025-11-testing-nemo.01.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
nl.ReUploadFile(projectname="FOX USI 49 Nordwind (CeBit 2014)",filename="fox_files/Nordwind (Reduced 2).fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
...
##nl.ReUploadFile(projectname="FOX USI 52 Nordwind (CeBit 2014)",filename="fox_files/Nordwind.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
