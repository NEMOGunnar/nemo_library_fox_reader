...
nl.ReUploadFile(projectname="FOX USI 99 Erste Bundesliga Trivialsport",filename="fox_files/Demodaten/BeispieltabellenInfoZoom2019/beispieldateien-cici/ErsteBundesliga.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
