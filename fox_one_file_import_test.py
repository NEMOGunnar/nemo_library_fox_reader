...
##nl.ReUploadFile(projectname="FOX USI 66 Bekleidungs-Shop",filename="../fox_files/Bekleidungs-Shop 2018 mit Analyse.fox",update_project_settings=False, statistics_only=False, foxReaderInfo=foxReaderInfo)
